...
SWFUpload.prototype.initSettings = function (init_settings) {
	...
	// Event Handlers
	this.fileDialogStart_handler	= this.retrieveSetting(init_settings.file_dialog_start_handler,		this.fileDialogStart);
	this.fileQueued_handler			= this.retrieveSetting(init_settings.file_queued_handler,			this.fileQueued);
	this.fileQueueError_handler		= this.retrieveSetting(init_settings.file_queue_error_handler,		this.fileQueueError);
	this.fileDialogComplete_handler	= this.retrieveSetting(init_settings.file_dialog_complete_handler,	this.fileDialogComplete);
	
	this.uploadStart_handler		= this.retrieveSetting(init_settings.upload_start_handler,			this.uploadStart);
	this.uploadProgress_handler		= this.retrieveSetting(init_settings.upload_progress_handler,		this.uploadProgress);
	this.uploadError_handler		= this.retrieveSetting(init_settings.upload_error_handler,			this.uploadError);
	this.uploadComplete_handler		= this.retrieveSetting(init_settings.upload_complete_handler,		this.uploadComplete);
	this.fileComplete_handler		= this.retrieveSetting(init_settings.file_complete_handler,			this.fileComplete);

	this.debug_handler				= this.retrieveSetting(init_settings.debug_handler,			   		this.debug);
};
