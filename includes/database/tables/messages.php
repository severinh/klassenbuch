...
class TableMessages extends Table {
	...
	*/
	public function check() {
		...
		if (!$this->date) {
			$this->setError("The message must have a date.");
		} else if (empty($this->text)) {
			$this->setError("The message must have some text.");
		} else if (!$this->userid) {
			$this->setError("The message must have an author.");
		} else {
			return true;
		}
